console.log('%cCopyright © 2025 HaSou游戏报', 'background-color: #ff00ff; color: white; font-size: 24px; font-weight: bold; padding: 10px;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var center = document.getElementById("PageLoading-HaSou-center");
    setTimeout(function () {
        checkProjectItems();
